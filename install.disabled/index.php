...
//intl extension is optional for installation in some local environments.
if ($php_version_success && $mysql_success && $curl_success && $mbstring_success && $gd_success && $json_success && $mysqlnd_success && $xml_success && $zlib_success) {
