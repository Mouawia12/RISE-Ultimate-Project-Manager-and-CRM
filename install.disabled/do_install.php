...
try {
    ...
    if (isset($_POST)) {
        ...
        $sql = str_replace('APP-VERIFICATION-KEY', $app_verification_key, $sql);
...
function verify_rise_purchase_code($code) {
    ...
    $url = $app_update_url . "?api_version=2&type=install&code=" . $code . "&domain=" . $_SERVER['HTTP_HOST'];
