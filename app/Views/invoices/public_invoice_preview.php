<?php
$html_lang = app_lang("language_locale");
if (!$html_lang || $html_lang == "default_lang.language_locale") {
    $html_lang = "en";
}
$dir = app_lang("text_direction") == "rtl" ? "rtl" : "ltr";
?>
<!DOCTYPE html>
