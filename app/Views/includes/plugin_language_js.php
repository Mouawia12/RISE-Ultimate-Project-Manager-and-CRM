...
$validation_err = app_lang("license_error_prefix") . " " . app_lang('something_went_wrong');
if ($validation_err === "license_error_prefix " . app_lang('something_went_wrong')) {
    $validation_err = "License error. " . app_lang('something_went_wrong');
}
if (isset($login_user->is_admin) && $login_user->is_admin) {
    $validation_err = app_lang("no_active_license_message");
    if ($validation_err === "no_active_license_message") {
